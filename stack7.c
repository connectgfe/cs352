...
//printlst(head);
      ...
      if(retval==1){
       if(head->val==NULL){
        fprintf(stderr,"Error in operator (1a)\n");
        status=1;
        continue;}
       if(head->next->val==NULL){
        fprintf(stderr,"Error in operator (2a)\n");
        status=1;
        continue;}
        char *temp1=pop(&head);
        char *temp2=pop(&head);
      ...
      if(retval==2){
       if(head->val==NULL){
        fprintf(stderr,"Error in operator (1b)\n");
        status=1;
        continue;}
       if(head->next->val==NULL){
        fprintf(stderr,"Error in operator (2b)\n");
        status=1;
        continue;}
      
        char *temp1=pop(&head);
        char *temp2=pop(&head);
        push(&head,strmath(add,temp2,temp1)); 
        free(temp1);
        free(temp2); 
       }
      if(retval==3){
...
//printf("yes zero: now num= %s\n",num);
    }
    size_t nlen2=strlen(num);
//printf("(2) numlen2,n,num: %lu %d %s\n",strlen(num),n,num);
