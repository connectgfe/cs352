...
*/
  ...
  char *v1name="John"; 
  addvert(verhead,strdup(v1name),graph);  
/*
  char *v2name="Ed"; 
  addvert(verhead,strdup(v2name),graph);  


  char *v3name="Phil"; 
  addvert(verhead,strdup(v3name),graph);  


  char *v4name="Steve";
  addvert(verhead,strdup(v4name),graph);
  char *v5name="Dan";
  addvert(verhead,strdup(v5name),graph);
  char *v6name="Ben";
  addvert(verhead,strdup(v6name),graph);
